...
#include "../../Viewer_Class/message.h"
...
const QMetaObject Message::staticMetaObject = {
    { &QFileDialog::staticMetaObject, qt_meta_stringdata_Message.data,
...
void *Message::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "B_Message"))
        return static_cast< B_Message*>(const_cast< Message*>(this));
